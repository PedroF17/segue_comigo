...
urlpatterns = [
    path('condutor/create/', CondutorView.as_view()),
    path('condutor/create/<int:pk>/', CondutorView.as_view()),
    ...
    path('condutor/veiculo/', VeiculoView.as_view()),
    path('condutor/veiculo/<int:pk>/', VeiculoView.as_view()),
    path('condutor/condutor_veiculo/', CondutorVeiculoView.as_view()),
    path('condutor/condutor_associar/<int:pk>/', AssociarCondutorVeiculoView.as_view()),
    path('condutor/veiculo_status/<int:pk>/', EstadoVeiculoView.as_view()),
